...
cyg_hercules_range_table2 = {
    "SINGLE_FI_CH0_5uA": 48,
    "SINGLE_FI_CH0_20uA": 49,
    "SINGLE_FI_CH0_200uA": 50,
    "SINGLE_FI_CH0_2mA": 51,
    "SINGLE_FI_CH0_external": 52,
    "SINGLE_MI_CH0_5uA": 53,
    "SINGLE_MI_CH0_20uA": 54,
    "SINGLE_MI_CH0_200uA": 55,
    "SINGLE_MI_CH0_2mA": 56,
    "SINGLE_MI_CH0_external": 57,

    "SINGLE_FI_CH1_5uA": 58,
    "SINGLE_FI_CH1_20uA": 59,
    "SINGLE_FI_CH1_200uA": 60,
    "SINGLE_FI_CH1_2mA": 61,
    "SINGLE_FI_CH1_external": 62,
    "SINGLE_MI_CH1_5uA": 63,
    "SINGLE_MI_CH1_20uA": 64,
    "SINGLE_MI_CH1_200uA": 65,
    "SINGLE_MI_CH1_2mA": 66,
    "SINGLE_MI_CH1_external": 67,

    "SINGLE_FI_CH2_5uA": 68,
    "SINGLE_FI_CH2_20uA": 69,
    "SINGLE_FI_CH2_200uA": 70,
    "SINGLE_FI_CH2_2mA": 71,
    "SINGLE_FI_CH2_external": 72,
    "SINGLE_MI_CH2_5uA": 73,
    "SINGLE_MI_CH2_20uA": 74,
    "SINGLE_MI_CH2_200uA": 75,
    "SINGLE_MI_CH2_2mA": 76,
    "SINGLE_MI_CH2_external": 77,

    "SINGLE_FI_CH3_5uA": 78,
    "SINGLE_FI_CH3_20uA": 79,
    "SINGLE_FI_CH3_200uA": 80,
    "SINGLE_FI_CH3_2mA": 81,
    "SINGLE_FI_CH3_external": 82,
    "SINGLE_MI_CH3_5uA": 83,
    "SINGLE_MI_CH3_20uA": 84,
    "SINGLE_MI_CH3_200uA": 85,
    "SINGLE_MI_CH3_2mA": 86,
    "SINGLE_MI_CH3_external": 87,
...
class CYG_HERCULES_LITE_V2(CYGModuleDriver, StreamServiceBuffered):
    ...
    def __init__(self, i2c_eeprom, i2c_dac_and_io, dma=None, ipcore=None):
        ...
        if self.low_limit>=CYGHERCULESLITEDef.LOW_LIMIT_VOL:
            self.cal_table = cyg_hercules_range_table2
        else:
    ...
    def set_single_pmu_clamp_curr(self, channel, clamp_low_curr,
        ...
        Rsense = CYGHERCULESLITEDef.RSENSE_I_RANGE[I_range]
        I_range_gear = 1e-3 if Rsense > 500 else 1
        assert clamp_high_curr - clamp_low_curr >= 0.05 * CYGHERCULESLITEDef.RANGE_LIMITS[I_range]
        code_low_curr = (
