...
from mix.driver.cyg.common.ipcore.mix_ad7768_cyg import MIXAD7768CYG
...
class CYGHERCULESLITEDef:
    ...
    RANGE_LIMITS = {
        ...
        "external": 80 * OVERLOAD_COFFI
    }

    FI_CH0_5uA = "FI_CH0_5uA"
    FI_CH0_20uA = "FI_CH0_20uA"
    FI_CH0_200uA = "FI_CH0_200uA"
    FI_CH0_2mA = "FI_CH0_2mA"
    FI_CH0_external = "FI_CH0_external"
    FI_CH1_5uA = "FI_CH1_5uA"
    FI_CH1_20uA = "FI_CH1_20uA"
    FI_CH1_200uA = "FI_CH1_200uA"
    FI_CH1_2mA = "FI_CH1_2mA"
    FI_CH1_external = "FI_CH1_external"
    FI_CH2_5uA = "FI_CH2_5uA"
    FI_CH2_20uA = "FI_CH2_20uA"
    FI_CH2_200uA = "FI_CH2_200uA"
    FI_CH2_2mA = "FI_CH2_2mA"
    FI_CH2_external = "FI_CH2_external"
    FI_CH3_5uA = "FI_CH3_5uA"
    FI_CH3_20uA = "FI_CH3_20uA"
    FI_CH3_200uA = "FI_CH3_200uA"
    FI_CH3_2mA = "FI_CH3_2mA"
    FI_CH3_external = "FI_CH3_external"
    FV_CH0 = "FV_CH0"
    FV_CH1 = "FV_CH1"
    FV_CH2 = "FV_CH2"
    FV_CH3 = "FV_CH3"
    ...
    MI_CH0_5uA = "MI_CH0_5uA"
    MI_CH1_5uA = "MI_CH1_5uA"
    MI_CH2_5uA = "MI_CH2_5uA"
    MI_CH3_5uA = "MI_CH3_5uA"

    MI_CH0_20uA = "MI_CH0_20uA"
    MI_CH1_20uA = "MI_CH1_20uA"
    MI_CH2_20uA = "MI_CH2_20uA"
    MI_CH3_20uA = "MI_CH3_20uA"

    MI_CH0_200uA = "MI_CH0_200uA"
    MI_CH1_200uA = "MI_CH1_200uA"
    MI_CH2_200uA = "MI_CH2_200uA"
    MI_CH3_200uA = "MI_CH3_200uA"

    MI_CH0_2mA = "MI_CH0_2mA"
    MI_CH1_2mA = "MI_CH1_2mA"
    MI_CH2_2mA = "MI_CH2_2mA"
    MI_CH3_2mA = "MI_CH3_2mA"

    MI_CH0_external = "MI_CH0_external"
    MI_CH1_external = "MI_CH1_external"
    MI_CH2_external = "MI_CH2_external"
    MI_CH3_external = "MI_CH3_external"
...
cyg_hercules_range_table = {
    CYGHERCULESLITEDef.FI_CH0_5uA : 0,
    CYGHERCULESLITEDef.FI_CH0_20uA : 1,
    CYGHERCULESLITEDef.FI_CH0_200uA: 2,
    CYGHERCULESLITEDef.FI_CH0_2mA : 3,
    CYGHERCULESLITEDef.FI_CH0_external: 4,
    CYGHERCULESLITEDef.FI_CH1_5uA: 5,
    CYGHERCULESLITEDef.FI_CH1_20uA: 6,
    CYGHERCULESLITEDef.FI_CH1_200uA: 7,
    CYGHERCULESLITEDef.FI_CH1_2mA: 8,
    CYGHERCULESLITEDef.FI_CH1_external: 9,
    CYGHERCULESLITEDef.FI_CH2_5uA : 10,
    CYGHERCULESLITEDef.FI_CH2_20uA: 11,
    CYGHERCULESLITEDef.FI_CH2_200uA: 12,
    CYGHERCULESLITEDef.FI_CH2_2mA : 13,
    CYGHERCULESLITEDef.FI_CH2_external: 14,
    CYGHERCULESLITEDef.FI_CH3_5uA : 15,
    CYGHERCULESLITEDef.FI_CH3_20uA : 16,
    CYGHERCULESLITEDef.FI_CH3_200uA: 17,
    CYGHERCULESLITEDef.FI_CH3_2mA : 18,
    CYGHERCULESLITEDef.FI_CH3_external: 19,
    CYGHERCULESLITEDef.FV_CH0 : 20,
    CYGHERCULESLITEDef.FV_CH1 : 21,
    CYGHERCULESLITEDef.FV_CH2 : 22,
    CYGHERCULESLITEDef.FV_CH3 : 23,
    CYGHERCULESLITEDef.MV_CH0 : 24,
    CYGHERCULESLITEDef.MV_CH1 : 25,
    CYGHERCULESLITEDef.MV_CH2 : 26,
    CYGHERCULESLITEDef.MV_CH3 : 27,
    CYGHERCULESLITEDef.MI_CH0_5uA : 28,
    CYGHERCULESLITEDef.MI_CH0_20uA : 29,
    CYGHERCULESLITEDef.MI_CH0_200uA: 30,
    CYGHERCULESLITEDef.MI_CH0_2mA : 31,
    CYGHERCULESLITEDef.MI_CH0_external: 32,
    CYGHERCULESLITEDef.MI_CH1_5uA : 33,
    CYGHERCULESLITEDef.MI_CH1_20uA: 34,
    CYGHERCULESLITEDef.MI_CH1_200uA: 35,
    CYGHERCULESLITEDef.MI_CH1_2mA : 36,
    CYGHERCULESLITEDef.MI_CH1_external: 37,
    CYGHERCULESLITEDef.MI_CH2_5uA : 38,
    CYGHERCULESLITEDef.MI_CH2_20uA: 39,
    CYGHERCULESLITEDef.MI_CH2_200uA: 40,
    CYGHERCULESLITEDef.MI_CH2_2mA : 41,
    CYGHERCULESLITEDef.MI_CH2_external: 42,
    CYGHERCULESLITEDef.MI_CH3_5uA : 43,
    CYGHERCULESLITEDef.MI_CH3_20uA : 44,
    CYGHERCULESLITEDef.MI_CH3_200uA: 45,
    CYGHERCULESLITEDef.MI_CH3_2mA : 46,
    CYGHERCULESLITEDef.MI_CH3_external: 47
}
...
class CYG_HERCULES_LITE(CYGModuleDriver, StreamServiceBuffered):
    rpc_public_api = [
        ...
        'multi_pmu_enable', "control_loop", 'set_single_pmu_clamp_vol',
        'get_single_pmu_clamp_vol', 'write_zero_offset_2_eeprom',
        'set_single_pmu_clamp_curr', 'get_single_pmu_clamp_curr',
        'set_zero_offset', 'clear_multi_pmu_alarm', 'set_single_pmu_meas_mode',
        'get_dut_volt', 'get_single_pmu_meas_mode', 'single_pmu_enable',
        'single_pmu_disable', 'set_sys_meas_out_gain', 'get_sys_meas_out_gain',
        "read_all", 'set_sys_thermal_shutdown_temp', 'open_stream', 'pre_thread_launch',
        ...
        'set_dut_volt', 'set_multi_pmu_curr_range', 'set_multi_pmu_mode',
        'multi_pmu_disable', 'set_ADA4870_status', 'get_channel_zero_offset'
    ] + CYGModuleDriver.rpc_public_api + StreamServiceBuffered.streamservice_api

    def __init__(self, i2c_eeprom, i2c_dac_and_io, dma, ipcore=None):
        if i2c_eeprom and i2c_dac_and_io:
            self.eeprom = CAT24C32(i2c_eeprom,
                                   CYGHERCULESLITEDef.EEPROM_DEV_ADDR)
            self.cat9555 = CAT9555(i2c_dac_and_io,
                                   CYGHERCULESLITEDef.IO_EXPEND_ADDR)
            self.mcp4725 = MCP4725(i2c_dac_and_io,
                                   CYGHERCULESLITEDef.DAC_POWER_ADDR)
        else:
        ...
        if isinstance(ipcore, str):
            ...
            self.axi4_bus = AXI4LiteBus('/dev/MIX_HERCULES_CYG_0', 65536)
        ...
        self.ad7768 = MIXAD7768CYG(self.axi4_bus, 5000, 5000)
        self.base_dac_offset = 0x57C5
        self.low_limit = -6000
        self.high_limit = 16500
        # super(CYG_HERCULES_LITE,
    ...
    def power_on_init(self):
        ...
        self.select_range = ["2mA", "2mA", "2mA", "2mA"]
        self.set_ADA4870_status(1)
        self.ad7768.reset()
        self.ad7768.set_control_mode("spi")
        self.select_ad_spi(1)
        self.ad5522.set_system_control(cmd_sys)
        self.set_dut_volt(6000)
        self.ad5522.set_dac_offset_value(int(self.base_dac_offset))
        self.update_dac_and_pmu_reg()
        self.set_zero_offset()
        return "done"

    def get_channel_zero_offset(self, channel, dac_mode, curr_range=None):
        '''
        Get zero code in each channel and range.
        '''
        range_dict = {'5uA': 0, '20uA': 1, '200uA': 2, '2mA': 3, 'external': 4}
        if dac_mode == "FV":
            addr = CYGHERCULESLITEDef.RAW_OFFSET_ADDRESS + 80 + 4 * int(
                channel[2:])
        else:
            addr = CYGHERCULESLITEDef.RAW_OFFSET_ADDRESS + (range_dict[curr_range] + \
                              int(channel[2:]) * 4 + int(channel[2:])) * 4
        data = self.eeprom.read(addr, 4)
        s = struct.Struct('4B')
        pack_data = s.pack(*data)
        s = struct.Struct('i')
        pack_data = s.unpack(pack_data)[0]

        return pack_data

    def set_zero_offset(self):
        '''
        Set zero raw offset to C reg.
        ...
        '''
        self.zero_offset = []
        curr_range = ['5uA', '20uA', '200uA', '2mA', 'external']
        pack_data = 0x8000
        for num in range(24):
            err_code = 0
            data = self.eeprom.read(
                CYGHERCULESLITEDef.RAW_OFFSET_ADDRESS + 4 * num, 4)
            for i in data:
                if i == 255:
                    err_code = err_code + 1
            if err_code >= 2:
                ...
                _data = s.pack(*data)
                s = struct.Struct('i')
                pack_data = s.unpack(_data)[0]
            if num < 20:
                self.ad5522.set_dac_c_reg(1 << (24 + int(num / 5)),
                                          f"FIN_{curr_range[num%5]}",
                                          int(pack_data))
            else:
                self.ad5522.set_dac_c_reg(1 << (4 + int(num)), "FIN_Vol",
                                          int(pack_data))
            self.zero_offset.append(pack_data)
            self.update_dac_and_pmu_reg()
        return self.zero_offset

    def write_zero_offset_2_eeprom(self,
                                   channel,
                                   dac_mode,
                                   offset_value,
                                   curr_range=None):
        '''
        Write zero offset to eeprom.
        ...
        assert dac_mode in ["FV", "FI"]

        range_dict = {'5uA': 0, '20uA': 1, '200uA': 2, '2mA': 3, 'external': 4}
        addr = 0
        s = struct.Struct('i')
        pack_data = s.pack(int(offset_value))
        s = struct.Struct('4B')
    ...
    def set_single_pmu_vol(self, channel, vol):
        '''
        set single pmu's voltage value, 0 ~ 18000 mV.
        ...
        if meas_mode == "MI":
            ...
            if 0 <= vol <= 4000:
                self.set_sys_meas_out_gain(0, 0)
            else:
                self.set_sys_meas_out_gain(0, 1)
        if channel == "ch1":
            vamp = 2250 + vol
    ...
    def set_single_pmu_curr_range(self, channel, curr_range):
        ...
        self.select_ad_spi(1)
        if channel == "ch1" and curr_range != "external":
            self.set_ADA4870_status(0)
        elif channel == "ch1" and curr_range == "external":
            self.set_ADA4870_status(1)
        else:
            pass
    ...
    def set_single_pmu_curr(self, channel, curr):
        ...
        Args:
            channel: str, select in ["ch0", "ch1", "ch2", "ch3"]
            curr: int,
                    5uA, 20uA, 200uA and 2mA can only be used in ch0, ch2 and ch3.
                    0 ~ 150 mA for ch1 in external mode.
                    0 ~ 89 mA for ch0, ch2, ch3 in external mode.
    ...
    def get_single_pmu_curr(self, channel):
        '''
        get single pmu's current value, 0 ~ 150 mA, step is 1mA.
    ...
    def set_single_pmu_clamp_vol(self, channel, clamp_low_volt,
        ...
        self.ad5522.set_clamp_vol(CYGHERCULESLITEDef.AD5522_CHANNEL[channel],
    ...
    def get_single_pmu_clamp_vol(self, channel):
        ...
        low_code = self.ad5522.read_dac_reg_x_back(
            CYGHERCULESLITEDef.AD5522_CHANNEL[channel], "CLL_Vol")
        high_code = self.ad5522.read_dac_reg_x_back(
            CYGHERCULESLITEDef.AD5522_CHANNEL[channel], "CLH_Vol")
    ...
    def set_single_pmu_clamp_curr(self, channel, clamp_low_curr,
        ...
        '''
        assert channel in CYGHERCULESLITEDef.AD5522_CHANNEL.keys()
        self.ad5522.disable_chen([CYGHERCULESLITEDef.AD5522_CHANNEL[channel]])
        self.update_dac_and_pmu_reg()
        I_range = self.select_range[int(channel[2:])]
        Rsense = CYGHERCULESLITEDef.RSENSE_I_RANGE[I_range]
        I_range_gear = 1e-3 if Rsense > 500 else 1
        if channel == "ch1":
            if "external" in I_range:
                Rsense = 5
                assert clamp_high_curr - clamp_low_curr >= 0.05 * 150
            else:
                assert clamp_high_curr - clamp_low_curr >= 0.05 * CYGHERCULESLITEDef.RANGE_LIMITS[
                    I_range]
        else:
            assert clamp_high_curr - clamp_low_curr >= 0.05 * CYGHERCULESLITEDef.RANGE_LIMITS[
                I_range]
        ...
        code_high_curr = (
            ...
            (4.5 * 5000)) + 32768
        self.select_ad_spi(1)
        self.ad5522.set_clamp_curr(CYGHERCULESLITEDef.AD5522_CHANNEL[channel],
    ...
    def get_single_pmu_clamp_curr(self, channel):
        ...
        I_range = self.select_range[int(channel[2:])]
        Rsense = CYGHERCULESLITEDef.RSENSE_I_RANGE[I_range]
        if channel == "ch1" and I_range == "external":
            Rsense = 5
        I_range_gear = 1e3 if Rsense > 500 else 1
        unit = "uA" if Rsense > 500 else "mA"
        code_low_curr = self.ad5522.read_dac_reg_x_back(
            CYGHERCULESLITEDef.AD5522_CHANNEL[channel], "CLL_Curr")
        code_high_curr = self.ad5522.read_dac_reg_x_back(
            CYGHERCULESLITEDef.AD5522_CHANNEL[channel], "CLH_Curr")
    ...
    def get_multi_meas_result(self, channel_list, mean_num=10, retry_times=5):
        ...
        for _ in range(retry_times):
            mv_result = self.ad7768.measure(channel_list, mean_num)
            mv_result = {
                channel: mv_result[int(channel[2:])]
                for channel in channel_list
            }
            if False not in [
                    len(data) == mean_num for _, data in mv_result.items()
            ]:
                settled = True
                break
            else:
        ...
        for channel, data in mv_result.items():
            ...
            if meas_mode == 'MV':
                ...
                if gain_select == 0.2:
                    volt = self.calibrate(calibrate_item,
                                          (1 / gain_select) * data +
                                          self.low_limit)
                else:
                    volt = self.calibrate(calibrate_item,
                ...
                Rsense = CYGHERCULESLITEDef.RSENSE_I_RANGE[I_range]
                if channel == "ch1" and self.select_range[int(
                        channel[2:])] == "external":
                    Rsense = 5
                I_range_gear = 1e3 if Rsense > 500 else 1
                i_unit = " uA" if Rsense > 500 else " mA"
                curr = self.calibrate(calibrate_item, (data - (11250 * 0.2)) /
                                      (2 * Rsense) * I_range_gear)
    ...
    def set_dut_volt(self, volt):
        '''
        Set mcp amp voltatge.
        ...
        Return:
            "done"
        '''
        Vmcp_set = (11280 - volt) / 6.71
        self.mcp4725.output_volt_dc(Vmcp_set)
        self.Vmcp4725_Vamp = volt
        return "done"

    def get_dut_volt(self):
        '''
        Get mcp4725 Vamp value.
    ...
    def write_module_calibration(self, channel, calibration_vectors=None):
        ...
        assert channel in list(cyg_hercules_range_table.keys())

        cal_index = cyg_hercules_range_table[channel]
    ...
    def set_ADA4870_status(self, status):
        '''
        ...
        self.ip_control.set_ADA4870_pin(status)
        return 'done'
    ...
    def sequence_set_single_pmu_curr(self, channel, curr, continue_time):
        ...
        self.ad5522.sequence_enable_pmu(
            CYGHERCULESLITEDef.AD5522_CHANNEL[channel], 0)
        return "done"
        ...
        for i in range(count):
            for num, ch in enumerate(channel_list):
                self.sequence_set_single_pmu_curr(
                    ch, curr_list[num],
                    int(125 * (continue_time_list[num] - 9.4 + raise_time1)))
                # self.sequence_set_single_pmu_curr(ch, 0, int(125 * (channel_change_time_list[num] - 9.4 + raise_time2)))
    ...
    def set_dac_range(self, low_vol):
        '''
